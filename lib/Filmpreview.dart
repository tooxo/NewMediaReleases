    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(64.0, 14.0, 165.0, 20.0),
                    size: Size(354.0, 47.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
          ...
          Transform.translate(
            offset: Offset(25.0, 181.0),
            child:
                // Adobe XD layer: 'Filmpreview' (none)
              ...
              child: Wrap(
                ...
                children: [{}, {}, {}, {}, {}, {}].map((map) {
                  return
                      // Adobe XD layer: 'Filmpreview' (group)
                      SizedBox(
                    width: 150.0,
                    height: 175.0,
                    child: Stack(
